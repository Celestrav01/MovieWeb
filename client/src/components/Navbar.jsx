...
const Navbar = () => {
  ...
  return (
    <div className='fixed top-0 left-0 z-50 w-full flex item-center justify-between px-6 md:px-16 py-5'>
      <Link to='/' className='max-md:flex-1'>
        <img 
            src={assets.logo} 
            alt="QuickShow Logo" 
            className='w-40 h-auto mt-2 transition-opacity duration-75' 
