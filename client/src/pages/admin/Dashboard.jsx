...
const Dashboard = () => {
  ...
  const dashboardCards = [
    { title: "Total Bookings", 
      value: dashboardData.tottalBookings || "0", 
      icon: ChartLineIcon 
    },
    ...
    <>
      ...
      <div className='relative flex flex-wrap gap-6 mt-4 max-w-5xl'>
          ...
          {dashboardData.activeShows.map((show) =>(
            <div key={show._id} className='w-[calc(25%-18px)] rounded-lg overflow-hidden h-full pb-3 bg-primary/10 border border-primary/20 hover:-translate-y-1 transition duration-300'>
              <img src={image_base_url + show.movie.poster_path} alt="" className='h-55 w-full object-cover'/>
