...
const MyBookings = () => {
  ...
  const {user,axios,image_base_url, getToken} = useAppContext()
  ...
  return !isLoading ? (
    ...
    <div className="relative px-6 md:px-16 lg:px-24 pt-20 md:pt-30 min-h-[80vh]">
      ...
      {(bookings || []).map((item,index) =>(
        ...
        bg-primary/8 border border-primary/20 rounded-lg mt-4 p-2 max-w-2xl">
          <div className="flex flex-col md:flex-row items-center">
            <img src={image_base_url + item.show.movie.poster_path} alt="" className="md:max-w-45 w-40 h-28 object-cover object-bottom rounded" />
